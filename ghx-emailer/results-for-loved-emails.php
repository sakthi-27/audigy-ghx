...
$results_forloved_email = '<!DOCTYPE html>
<html lang="en">
  ...
  <table style="width: 640px; border-collapse: collapse;" width="640">
    ...
    <tbody>
      ...
      <tr class="content" style="background: #e1eaf3;">
        <td style="padding:10px 2em; vertical-align: middle;" valign="middle"><p>'.$content.'</p></td> 
      </tr>
      ...
      <tr class="footer" style="background: #6548c5; color: #fff; text-align: center; font-size: 0.9em;" align="center">
        <td style="padding: 2em; vertical-align: middle;text-align:center; padding-bottom: 3em;" valign="middle">
        ...
        $results_forloved_email .=  '<span>
              <a href="'.$email_privacy_policy.'" style="color: #fff;">Privacy Policy</a>
           </span>';
        }
